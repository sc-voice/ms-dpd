export const ABBREVIATIONS = {
  ...
  "ind": {
    "abbreviation": "nin",
    "meaning": "No tiene inflexiones",
    "explanation": "No tiene declinaciones ni conjugaciones."
  },
  "inf": {
    "abbreviation": "inf",
  ...
  "pron": {
    "abbreviation": "pron",
    "meaning": "pronoun, pronominal adjective",
    "explanation": "A function word that is used in place of a noun or noun phrase (he; this; another; all)"
  },
  "prp": {
    "abbreviation": "prp",
