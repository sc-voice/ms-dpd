  ...
  describe('pali', () => {
    ...
    it('compareOCBS()', () => {
      ...
      let test = (items, expected) => {
        let sorted = items
          .split(' ')
          .sort(Pali.compareOCBS)
          .join(' ');
        should(sorted).equal(expected);
      };

      test(
        'āsava ācariya ananta ānanda',
        'ananta ācariya ānanda āsava',
      );
      ...
      test(
        'saṃyuta saṃyutta saṃyojita saṃyojana',
        'saṃyuta saṃyutta saṃyojana saṃyojita',
      );
      test(
        'rāga lakkhaṇa yakkha vacana',
        'yakkha rāga lakkhaṇa vacana',
      );
      test(
        'khattiya khandha khanti khama',
        'khattiya khanti khandha khama',
      );
      test(
        'icchati iñjati icchā iṭṭha',
        'icchati icchā iñjati iṭṭha',
      );
    ...
    it('compare endings()', () => {
      let pali = new Pali();
      let endings = ['-iṃ', '-ī', '-iyo', '-i', '-ī', '-iyā', '-īhi'];
