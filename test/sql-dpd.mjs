...
typeof describe === 'function' &&
  describe('sql-dpd', function () {
    ...
    it('build()', async () => {
      ...
      should(defPali['8sz']).equal(
        'ī fem|fem|√div > dev+*a+ī\ndeva+ī|dev|devī 1',
      );

      should(defMap['evaṁ']).equal('4iU,4iV');
      should(defLang['4iU']).match(/thus; this/);
      should(defPali['4iU']).equal('|ind|eva+aṃ|-|evaṃ 1');
