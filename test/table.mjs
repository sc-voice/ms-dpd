...
typeof describe === 'function' &&
  describe('table', () => {
    ...
    it('asColumns()', () => {
      ...
      let tbl = Table.fromArray2(data, opts);
      dbg && console.log(msg, '[1]tbl', tbl);
      let lines = tbl.asColumns();
      dbg && console.log(msg, '[2]lines', lines);
    ...
    it('format()', () => {
      ...
      should(frLines[0]).match(/Color {2}Size Date/i);
      should(frLines[1]).match(/purple {3}10 01.02.2000/);
    });
    it('titleOfId', () => {
    ...
    it('findHeader', () => {
      ...
      let tbl = Table.fromArray2(TEST_GROUP, {
        title: '---findHeader---',
      });
